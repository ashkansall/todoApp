                ...
                <div onClick={onComplete} className={`todoText ${todo.isCompleted ? "completed" : ""}`}>{todo.text}</div>
                    <div>
                        <button className="btn-edit" onClick={onEdit}>
                            <svg fill="#f9f871" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50" width="20px" height="20px">
                        ...
                        <svg fill="red" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="20px" height="20px">
